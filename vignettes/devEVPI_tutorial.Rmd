...
Perfect Information (EVPI) for risk prediction models, as introduced in [our 2022 paper in Medical Decision Makiing](https://journals.sagepub.com/doi/10.1177/0272989X06295361?url_ver=Z39.88-2003&rfr_id=ori:rid:crossref.org&rfr_dat=cr_pub%20%200pubmed)
...
-   We calculate EVPI as the expected distance in net benefit (NB)
    ...
    development data). We can then judge the value of EVPI to decide
